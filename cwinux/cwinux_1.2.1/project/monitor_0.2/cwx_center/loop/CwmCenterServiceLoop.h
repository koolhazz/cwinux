...
@brief 模板的loop对象，实现Center所管理的一个system的service信息输出。
...
private:
    ...
    map<string/*service name*/, CwmCenterService*> const* m_pService; ///<service对象的列表
    map<string/*service name*/, CwmCenterService*>::const_iterator m_service_iter; ///<loop的当前service
